...
export default function UserNotifications() {
    ...
    useEffect(() => {
        ...
        const storedNotifications: StoredNotification[] = JSON.parse(localStorage.getItem('userNotifications') || '[]');
    ...
    const markAsRead = (id: number) => {
        ...
        localStorage.setItem('userNotifications', JSON.stringify(updatedStoredNotifications));
    };
